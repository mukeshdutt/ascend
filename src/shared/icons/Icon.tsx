// Central SVG icon registry. All icons are 24x24 line icons that inherit
// `currentColor`, so they render correctly both as neutral nav glyphs and as
// white glyphs inside the colored module badges.
...
const ICONS = {
  ...
  analytics: '<path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20v-4"/>',
  ...
  go: '<path d="M4 8c0-3 3.5-5 8-5s8 2 8 5v8c0 3-3.5 5-8 5s-8-2-8-5Z"/><circle cx="8.5" cy="9" r="2.2"/><circle cx="15.5" cy="9" r="2.2"/><circle cx="9" cy="9.4" r=".3"/><circle cx="15" cy="9.4" r=".3"/><path d="M11 13h2l-1 1.2Z"/><path d="M10.5 16c.9.7 2.1.7 3 0"/>',
} as const
